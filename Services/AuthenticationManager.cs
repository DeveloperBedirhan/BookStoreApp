...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        public async Task<IdentityResult> RegisterUser(UserForRegistrationDto userForRegDto)
        {
            var user = _mapper.Map<User>(userForRegDto);
            var result = await _userManager.CreateAsync(user, userForRegDto.Password);

            if (result.Succeeded)
                await _userManager.AddToRolesAsync(user, userForRegDto.Roles);
